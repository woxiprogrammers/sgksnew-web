...
var VendorFileUpload = function() {
    ...
    var e = function() {
        var e = new plupload.Uploader({
            ...
            init: {
                PostInit: function() {
                    $("#tab_images_uploader_filelist_vendor").html(""), $("#tab_images_uploader_uploadfiles_vendor").click(function() {
                        return e.start(), !1
                    }), $("#tab_images_uploader_filelist_vendor").on("click", ".added-files .remove", function() {
                        e.removeFile($(this).parent(".added-files").attr("id")), $(this).parent(".added-files").remove()
                    })
                },
                FilesAdded: function(up, files) {
                    plupload.each(files, function(e) {
                        if (up.files.length > up.settings.max_files) {
                            ...
                            $("#tab_images_uploader_filelist_vendor").append('<div class="alert alert-warning added-files" id="uploaded_file_' + e.id + '">' + e.name + "(" + plupload.formatSize(e.size) + ') <span class="status label label-info"></span>&nbsp;</div>')
                        }
                    })
                },
                UploadProgress: function(e, a) {
