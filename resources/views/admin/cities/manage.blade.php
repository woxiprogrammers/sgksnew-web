                    ...
                    <div class="page-content-wrapper">
                        <div class="page-head">
                            <div class="container">
                                ...
                                <div id="city_add" class="btn red-flamingo col-md-2 pull-right" style="margin-top: 1%"><a href="/cities/create" style="color: white">
                                        Add City
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet light ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="cityTable">
                                                    <thead>
                                                    <tr>
                                                        <th> Sr.No </th>
                                                        <th> City </th>
...
@section('javascript')
    ...
    <script src="/assets/custom/admin/cities/cities-listing.js" type="text/javascript"></script>
    ...
    <script>
        ...
        function statusFolder(status,id){
            if(confirm("Change Status! are you sure ?")){
                var route='/cities/change-status/'+id;
