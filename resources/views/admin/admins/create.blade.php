                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-body form">
                                            <form role="form" id="create-admin" class="form-horizontal" action="/admin/create" method="post">
                                                {!! csrf_field() !!}
...
@section('javascript')
    ...
    <script src="/assets/custom/admin/manageAdmins/create-admin-validation.js" type="text/javascript"></script>
