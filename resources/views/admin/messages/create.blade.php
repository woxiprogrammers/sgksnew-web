                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <div><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#collapse-form" style="background-color: white"><a class="dropdown-item">Buzz</a></button></div>
                                                        <div><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#collapse-form" style="background-color: white"><a class="dropdown-item">Nidhan</a></button></div>
                                                        <div><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#collapse-form" style="background-color: white"><a class="dropdown-item">Birthday</a></button></div>
                                                        <div><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#collapse-form" style="background-color: white"><a class="dropdown-item">Achievement</a></button></div>
                                                        <div><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#collapse-form" style="background-color: white"><a class="dropdown-item">General</a></button></div>
                                                </div>
                                            </div>
                                            <div id="collapse-form" class="collapse">
                                                <form role="form" id="create-messages" class="form-horizontal" action="/member/create" method="post">
                                                {!! csrf_field() !!}
