                        ...
                        <div class="page-head">
                            <div class="container">
                                ...
                                <div class="page-title">
                                    <h1>Committee Member Listing</h1>
                                </div>
                                <div id="member_add" class="btn red-flamingo" style="margin-top: 1%; margin-left: 77%"><a href="/committee/addMember" style="color: white">
                                        Add Member
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <div class="portlet light ">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="memberTable">
                                                    ...
                                                    <tr class="filter">
                                                        <th style="width: 20%"> <input type="text" class="form-control form-filter" name="search_member"> </th>
                                                        <th></th>
                                                        <th></th>
                                                        <th></th>
                                                        <th>
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <td>1</td>
                                                         <td>
                                                            <button><a href="/committee/addMember">Edit</a><i class="fa fa-edit"></i> </button>
                                                         </td>
                                                    </tbody>
                                                </table>
                                            </div>
